...
## Project Structure
    ...
    ├── testapiautostoryboa_63852  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_63852`
...
2. Clone this repo and `cd testapiautostoryboa_63852`
